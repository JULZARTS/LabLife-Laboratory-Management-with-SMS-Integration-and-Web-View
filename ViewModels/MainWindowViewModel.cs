...
namespace LabLife.ViewModels
{
    public partial class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new MenuItems { Title = "Dashboard",  command = new RelayCommand(GoDashboard)},
                new MenuItems { Title = "New Patient",  command = new RelayCommand(GoNewPatient)},
                new MenuItems { Title = "Records", command = new RelayCommand(GoRecords)},
                new MenuItems { Title = "Communications", command = new RelayCommand(GoCommunications)},
                new MenuItems { Title = "Web Inspect", Icon = "avares://LabLife/Assets/Icons/Home.svg", command = new RelayCommand(GoWebInspect)},
                new MenuItems { Title = "Settings", command = new RelayCommand(GoSettings)}
            };
        }
    }
}
